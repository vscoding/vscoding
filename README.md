...
<table width="100%" style="border-collapse:collapse; line-height:2.2;">
    <tr>
        <td style="padding:6px 0;">
            ...
            <img alt="Rust" src="https://img.shields.io/badge/Rust-CE412B?logo=rust&logoColor=white&style=flat-square" />
...
systems, network tools, infrastructure components, and oddly-satisfying engineering experiments.
